...
const registerUser = async (req, res, next) => {
    try {
        const { first_name, last_name, email, phone_no, address, emp_type, designation, image } = req.body;
        ...
        const user = await User.create({
          first_name, last_name, email, phone_no, address, emp_type, designation, image
        });
        ...
        if (user) {
            const { _id,  first_name, last_name, email, phone_no, address, emp_type, designation, image } = user;
            res.status(201).json({ _id,  first_name, last_name, email, phone_no, address, emp_type, designation, image, token });
        } else {
...
const getUserById = asyncHandler(async (req, res, next) => {
    ...
    if (user) {
        const { _id, first_name, last_name, email, phone_no, address, emp_type, designation, image } = user;
        res.status(201).json({ _id, first_name, last_name, email, phone_no, address, emp_type, designation, image });
    } else {
