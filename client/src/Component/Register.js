    ...
    <div className='container'>
      ...
      <form>
          ...
          <div className="md-3 col-lg-6 col-md-6 col-12">
              ...
              <input type="radio" name='emp_type' value={data.emp_type} onChange={inputHandler} className="form-control" id="exampleInputPassword1" placeholder="Enter your work information"/>
              <input type="radio" name='emp_type' value={data.emp_type} onChange={inputHandler} className="form-control" id="exampleInputPassword1" placeholder="Enter your work information"/>
          ...
          <div className="md-3 col-lg-12 col-md-6 col-12">
              ...
              <textarea type='text' name='designation' value={data.designation} onChange={inputHandler} className="form-control" cols='30' rows='5' placeholder="Describe yourself here"/>
          </div>
          <div className="md-3 col-lg-12 col-md-6 col-12">
